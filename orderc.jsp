<%-- 
    Document   : clerk
    Created on : 24 Mar, 2018, 4:32:25 PM
    Author     : Navneet
--%>
...
<section class="contact-w3ls">
	...
	<div style="margin-left:363px;" class="container" style="height: 300px;width: 100%;">		
		 <%
                try
                {
                    ...
                    %>
                    <table border="1">
                        <b> <th color="gray"><tr style='background:grey;color:white;'><td><b>SELECT ORDER</b></td><td><b>REFERENCE ID</b></td><td><b>CUSTOMER NAME</b></td><td><b>SOURCE ADDRESS</b></td><td><b>PIN CODE</b></td><td><b>PHONE NUMBER</b></td><td><b>LANDMARK</b></td><td><b>Process</b></td></tr></th></b>
                    <%
                    while(rs.next())
                    {
                        %>
...
<br><br><br><br><br>
	...
	<div class="container">
		...
		<p class="text-center"><font color="blue"><b></b></font></p>	
			...
			<form action="orderc1b.jsp" method="post" name="" id="contactForm" novalidate>
