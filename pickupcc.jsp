<%-- 
    Document   : pickupcc
    Created on : 19 Mar, 2018, 5:29:52 PM
    Author     : Navneet
--%>
...
<!-- navigation -->
            ...
            <div style=" margin-left: 0px; background:green; float:left; width:15%; height:787px; margin-top: 57px;">
                ...
                <div style="margin-left:203px; background:graytext; height:1000px; width:auto;">
<br><br><br><br>
<link rel="stylesheet" href="css/mycss.css">
    <center> 
        ...
        <form action="pickupcc1.jsp" class="b-filler" method="POST">
           <table border="0">
                <br>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td><input placeholder="Address" type="text" name="d_add" value="" />
