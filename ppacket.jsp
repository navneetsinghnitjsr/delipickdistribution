<%-- 
    Document   : ppacket
    Created on : 19 Mar, 2018, 4:48:32 PM
    Author     : Navneet
--%>
...
<!-- navigation -->
            ...
            <div style=" margin-left: 0px; background:green; float:left; width:15%; height:787px; margin-top: 57px;">
                ...
                <div style="margin-left:203px; background:graytext; height:auto; width:auto;">
        ...
        <form action="ppacket1.jsp" class="b-filler" method="POST">
           <table border="0">
            ...
            <br>  
                ...
                <a href="pickupcc.jsp" class="btn btn-primary"> Add New Record</a>
                </center>
        </form>
        <div class="container">
            <h5> <font color="green"><b>Please  Note:</b></font></h5>
                            <ul>
                                1.Pickup will be scheduled from Monday to Saturday between 10AM to 7PM - Except Holidays<br>
