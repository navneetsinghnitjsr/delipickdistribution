<%-- 
    Document   : responsec
    Created on : 26 Mar, 2018, 6:29:38 PM
    Author     : Navneet
--%>
...
<section class="contact-w3ls">
	...
	<div style="margin-left:233px;" class="container" style="height: 300px;width: 100%;">		
		 <%
                try
                {
...
<section class="contact-w3ls">
	...
	<div style="margin-left:443px;" class="container" style="height: 300px;width: 100%;">		
		 <%
                try
                {
